                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PalletReturnScreen2(
                          challanId: challanId!,
...
class PalletReturnScreen2 extends StatefulWidget {
  final String challanId;
  final List<String> scannedPallets;

  const PalletReturnScreen2(
      {super.key, required this.challanId, required this.scannedPallets});

  @override
  _PalletReturnScreen2State createState() => _PalletReturnScreen2State();
}

class _PalletReturnScreen2State extends State<PalletReturnScreen2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
void ConfirmReturnPopup(BuildContext context) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return AlertDialog(
          ...
          children: [
            ...
            RichText(
              ...
              text: const TextSpan(
                ...
                children: [
                  TextSpan(
                    text: "Are you sure you want to approve return ?",
                  ),
                ],
              ),
            ),
...
void RejectReturnpopup(BuildContext context) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return AlertDialog(
          ...
          children: [
            ...
            RichText(
              ...
              text: const TextSpan(
                ...
                children: [
                  TextSpan(
                    text: "Are you sure you want to reject return ?",
                  ),
                ],
              ),
            ),
